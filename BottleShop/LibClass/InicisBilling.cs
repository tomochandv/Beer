...
namespace BottleShop.LibClass
{
    public class InicisBilling
    {
        ...
        public InicisBilling (string price, string billKey)
        {
    ...
    public class InicisBillingCancle
    {
        public readonly string resultcode;
        public readonly string resultmsg;
        ...
        public readonly string pgauthtime;
        public readonly bool result;
        public InicisBillingCancle(string tid)
        {
            INItx41 INIpay = new INItx41();
            int intPInst = INIpay.Initialize("");
            try
